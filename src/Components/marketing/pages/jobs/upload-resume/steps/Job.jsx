            ...
            <Col md={12} xs={12} className="mb-4">
              ...
              <Form.Group className="mb-1 input-group">
                ...
                <Form.Text className="fs-6">
                  DOC, DOCx, PDF | Max: 2 MB. Recruiters give first preference
                  to candidates who have a good and well structure resume
                </Form.Text>
              </Form.Group>
            </Col>
            <Col md={12} xs={12} className="mb-3">
                      ...
                      <Form.Text className="fs-6">
                      Profile picture should be a PNG or JPG file of 500 x 500
                        pixels
                      </Form.Text>
                    </Col>
            <Col
